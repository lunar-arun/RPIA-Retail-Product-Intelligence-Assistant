...
🔗 **Live demo:** [rpia-retail-appuct-intelligence-assistant-lunar.streamlit.app](https://rpia-retail-appuct-intelligence-assistant-lunar.streamlit.app/)
...
```bash
git clone https://github.com/<your-username>/Retail-Product-Intelligence-Assistant-RPIA.git
cd Retail-Product-Intelligence-Assistant-RPIA
```
...
### 4. Generate the local sample data
